    ...
    return (
      <div className="space-y-8">
        <div className="text-center space-y-2">
          <div className="h-9 w-48 bg-secondary-200 dark:bg-secondary-700 rounded-full animate-pulse mx-auto" />
          <div className="h-5 w-72 bg-secondary-200 dark:bg-secondary-700 rounded-full animate-pulse mx-auto" />
        </div>
