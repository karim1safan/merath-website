const SOCIAL_LINKS = [
  ...
  {
    label: 'Twitter',
    url: 'https://twitter.com/karim_safan11',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-secondary-800 border-t border-secondary-200 dark:border-secondary-700 py-6 mt-auto transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src="/icon.png" alt="ميراث" className="w-6 h-6 rounded" />
